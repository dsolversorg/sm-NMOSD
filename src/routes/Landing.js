...
.checkbox-container input[type="checkbox"] {
  ...
  width: 35px; 
  height: 25px;
  border: 3px solid #790081; /* Azul escuro */
  border-radius: 5px; 
...
.checkbox-container input[type="checkbox"]:hover {
  border-color: #7F4584; /* Azul mais claro ao passar o mouse */
}

.checkbox-container input[type="checkbox"]:checked {
  background: linear-gradient(to bottom, #790081, #7F4584); /* Gradiente azul */
  border-color: #790081; /* Azul mais claro */
}
